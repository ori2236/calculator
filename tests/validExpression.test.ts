...
describe("the expression should stay the same", () => {
  ...
  test("closing bracket after operator, should return that Invalid adjustment to closing bracket", () => {
    const expression = "1+(5+(2+))";
    const expected: ValidExpression = {
      validationError: "Invalid adjustment to closing bracket",
  ...
  test("empty brackets should be invalid, should return that Invalid adjustment to closing bracket", () => {
  ...
  test("the expression end with operator or opening brackets, should return that cannot be calculated", () => {
    ...
    const expected: ValidExpression = {
      validationError: "Operator in edges",
